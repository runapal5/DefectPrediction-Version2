...
public class CsvFileWriter {
	...
	public static void writeCsvFile(String fileName, List<TrainedData> predResultList) {
		...
		try {
			...
			for (TrainedData trainedData : predResultList) {
				...
				fileWriter.append(COMMA_DELIMITER);
				fileWriter.append(String.valueOf(trainedData.getPrediction()));
				fileWriter.append(NEW_LINE_SEPARATOR);
			}
